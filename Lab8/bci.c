...
/* @brief: pushes nth index of register onto stack
   @param: n --- index of register to be pushed
   @return: void  */
...
/* @brief: stores TOS into nth index of register
   @param: n --- index of register 
   @return: void  */
...
/* @brief: moves the instruction pointer to n
   @param: n --- the instruction number to jump to
   @return: void  */
...
/* @brief: pops stack and if TOS = 0, jump to instruction n
   @param: n --- the instruction number to jump to
   @return: void  */
void do_jz(int n)
{
...
/* @brief: pops stack and if TOS is not 0, jump to instruction n
   @param: n --- the instruction number to jump to
   @return: void  */
void do_jnz(int n)
{
...
/* @brief: Replaces top two items of stack with the its sum
   @param: void
   @return: void  */
void do_add(void)
{
...
/* @brief: Replaces top two items of stack with the its difference
   @param: void
   @return: void  */
...
/* @brief: Replaces top two items of stack with the its product
   @param: void
   @return: void  */
...
/* @brief: Replaces top two items of stack with the its quotient
   @param: void
   @return: void  */
